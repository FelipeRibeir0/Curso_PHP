        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="name.php">Name</a></li>
            </ul>
          </li>
          <li class="nav-item">
  ...
  <div class="box_forms">
    <form name="dados" method="post" action="query.php">
      <div class="input">
        ...
        <input required pattern="^[a-zA-Z]*$" name="query" placeholder="Digite um nome" type="text">
      </div>
